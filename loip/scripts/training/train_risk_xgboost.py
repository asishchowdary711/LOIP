"""Train the risk_score XGBoost model on synthetic data.

Run with: .venv-ml/bin/python -m scripts.training.train_risk_xgboost
"""
...
DATA_PATH = Path(__file__).resolve().parent.parent.parent / "data" / "training" / "risk_synthetic.csv"
TASK = "risk_score"
